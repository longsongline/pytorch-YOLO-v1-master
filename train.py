...
file_root = r'C:\Users\86189\Desktop\py'
learning_rate = 0.001
num_epochs = 50
batch_size = 24
use_resnet = True
...
train_dataset = yoloDataset(root=file_root,list_file=['gesturetest.t.xt'],train=True,transform = [transforms.ToTensor()] )
...
test_dataset = yoloDataset(root=file_root,list_file='gesturetest.txt',train=False,transform = [transforms.ToTensor()] )
